...
For large result sets, use the Arrow interface for significantly better
performance. This requires the `nanoarrow` package.

```{r arrow}
# Returns a nanoarrow array stream (zero-copy where possible)
stream <- dbGetQueryArrow(con, "SELECT * FROM large_table")
