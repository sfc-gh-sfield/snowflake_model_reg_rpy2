...
# Install snowflakeR -- uncomment ONE option:

# Option 1: Install from GitHub via pak
install.packages("pak", type = "source", quiet = TRUE)
pak::pak("Snowflake-Labs/snowflakeR", ask = FALSE, upgrade = FALSE)

# Option 2: Install from local repo cloned into the Workspace
# install.packages("/path/to/snowflakeR", repos = NULL, type = "source")

library(snowflakeR)
```

### Step 4: Connect and set execution context
